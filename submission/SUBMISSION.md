...
- After the armed phase, to make it easier for the user to know when to start, I turn off the LED briefly before turning it on instantly as a signal and then trigger reaction()
...
- Based on the reaction time, the LED blinks at different speeds for feedback. I chose a blinking duration of 4.5 seconds so it is clearly visible to the user
